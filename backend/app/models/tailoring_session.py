...
class TailoringSession(Base):
    ...
    gaps_json: Mapped[dict] = mapped_column(JSONDoc, nullable=False)
    resolutions_json: Mapped[list] = mapped_column(JSONDoc, nullable=False, default=list)
    ...
    application_id: Mapped[uuid.UUID | None] = mapped_column(
        UUIDType(as_uuid=True), ForeignKey("applications.id", ondelete="SET NULL"), nullable=True
    )
